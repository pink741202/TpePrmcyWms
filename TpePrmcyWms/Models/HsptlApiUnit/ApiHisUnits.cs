...
{
    #region 出藥
    public class ApiQueryObj
    {
        public string HospId { get; set; } = ""; //院區代碼 (退藥,住院序號,住院退藥)
        public string PatNo { get; set; } = ""; //病歷號碼 (退藥,住院序號,住院退藥)
        public string PatSeq { get; set; } = ""; //病人序號 (退藥,住院退藥)
        ...
        public string ReturnSheet { get; set; } = ""; //退藥單號 (住院退藥)
        ...
        public ApiQueryObj() { }
        public ApiQueryObj(string[] scantext)
        {
            HospId = scantext[0];
            PatNo = scantext[6];
            PatSeq = scantext[7];
